        ...
        <div className="w-full flex h-14 max-w-[var(--max-width)] items-center mx-auto">
          <div className="w-full flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-x-2 overflow-x-auto">
              {routes.map((route) => (
                <Button
                  key={route.href} // ✅ FIXED
                  size="sm"
                  variant="ghost"
                  className={cn(
                    "w-full lg:w-auto font-normal py-4.5 hover:text-white border-none text-white/60 focus:bg-white/30 transition !bg-transparent !text-[14.5px]",
                ...
                <nav className="flex flex-col gap-y-2 pt-9">
                  {routes.map((route) => (
                    <Button
                      ...
                      variant="ghost"
                      className={cn(
                        "w-full font-normal py-4.5 hover:bg-white/10 hover:text-black border-none text-black/70 focus:bg-white/30 transition !bg-transparent justify-start",
